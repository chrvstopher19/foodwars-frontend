...
// either use {user} i.e destructuring or props as is
  return (
    <div className='nav'>
        ...
        <div></div>
        {user? <div className='nav-links'><NavLink to="/sign-out">Sign Out</NavLink><NavLink to="/add-character"><img id="add-char-img" src="https://cdn0.iconfinder.com/data/icons/game-ui-casual-chunky/533/IconsByAndreaFryer_GameUI_Chunky_AddFriend-512.png"/></NavLink></div>
